...
import 'package:khutaa/src/widgets/common/loader.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  CTextFormField(
                    ...
                    enabled: !context.watch<BaseProvider>().busy,
                  ),
                  ...
                  context.watch<BaseProvider>().busy
                      ? Center(child: Loader())
                      : Align(
